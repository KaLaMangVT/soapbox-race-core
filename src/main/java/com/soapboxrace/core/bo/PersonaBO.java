...
public class PersonaBO {
    ...
    public int getnumCarSlots(Long personaId) {
        PersonaEntity personaEntity = personaDAO.find(personaId);

        return personaEntity.getnumCarSlots();
    }

    public void setnumCarSlots(PersonaEntity personaEntity) {
        //PersonaEntity personaEntity = personaDAO.find(personaId);

        int numCarSlots = (personaEntity.getnumCarSlots()) + 1;
        personaEntity.setnumCarSlots(numCarSlots);
        //personaDAO.update(personaEntity);
    }
